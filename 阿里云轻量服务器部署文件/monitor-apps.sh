...
echo "🗄️ 数据库文件状态："
echo "-----------------------------------"
ssh_cmd "ls -lh /var/www/shops/fynony/prisma/prod.db 2>/dev/null || echo 'Shop1数据库未创建'"
ssh_cmd "ls -lh /var/www/shops/onewindoutdoors/prisma/prod.db 2>/dev/null || echo 'Shop2数据库未创建'"
